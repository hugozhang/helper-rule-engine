...
var convertConj = function convertConj(op, vals, conv, config, not, meta) {
  ...
  if (conjKey) {
    ...
    var complexFields = Object.values(children).map(function (v) {
      var _v$properties;
      return v === null || v === void 0 || (_v$properties = v.properties) === null || _v$properties === void 0 ? void 0 : _v$properties.field;
    }).filter(function (f) {
    ...
    var childrenInRuleGroup = Object.values(children).map(function (v) {
      var _v$properties2;
      return v === null || v === void 0 || (_v$properties2 = v.properties) === null || _v$properties2 === void 0 ? void 0 : _v$properties2.field;
    }).map(function (f) {
