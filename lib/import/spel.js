...
var convertArg = function convertArg(spel, conv, config, meta, parentSpel) {
  ...
  if (spel.type == "compound") {
    ...
    var isVariable = ((_spel$children = spel.children) === null || _spel$children === void 0 || (_spel$children = _spel$children[0]) === null || _spel$children === void 0 ? void 0 : _spel$children.type) == "variable";
    return {
      valueSrc: "field",
      //valueType: todo
    ...
    // todo: get from conv
    var funcToOpMap = (0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])({}, ".contains", "like"), ".startsWith", "starts_with"), ".endsWith", "ends_with"), "$contains", "select_any_in"), ".equals", "multiselect_equals"), "CollectionUtils.containsAny()", "multiselect_contains");
    ...
    if (methodName == "contains" && obj && obj[0].type == "list") {
      ...
      return buildRule(config, meta, _field, _opKey, _args3);
      ...
      if (_parts && convertedArgs.length == 1) {
        ...
        return buildRule(config, meta, _field2, _opKey2, convertedArgs);
      }
      ...
      if (args.length !== 2) {
        meta.errors.push("Expected args must have 2 arguments, but got ".concat(args.length, "."));
        return undefined;
      }
      var _dateString = args[0].val;
      var _dateFormat = args[1].val;
      var _valueType4 = _dateFormat.includes(" ") ? "datetime" : _dateFormat.includes("H") ? "time" : "date";
      var _field5 = null; // todo
      var _widget2 = _valueType4;
      var _fieldConfig2 = (0, _configUtils.getFieldConfig)(config, _field5);
      var _widgetConfig2 = config.widgets[_widget2 || (_fieldConfig2 === null || _fieldConfig2 === void 0 ? void 0 : _fieldConfig2.mainWidget)];
      var _valueFormat2 = _widgetConfig2.valueFormat;
      var _dateVal2 = (0, _moment["default"])(_dateString, _valueType4 === 'time' ? 'HH:mm:ss' : _moment["default"].ISO_8601);
      var _value4 = _dateVal2.isValid() ? _dateVal2.format(_valueFormat2) : undefined;
      return {
        valueSrc: "value",
        valueType: _valueType4,
        value: _value4
      };
    } else {
      // todo: conv.funcs
  ...
  if (spel.type.indexOf("op-") == 0) {
    ...
    if (op == "and" || op == "or") {
      ...
      if (!fieldObj) {
        ...
        var groupField = fieldObj.groupFieldValue.value;
