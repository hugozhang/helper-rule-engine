...
var SqlString = exports.SqlString = require("sqlstring");
...
var sqlEmptyValue = exports.sqlEmptyValue = function sqlEmptyValue(fieldDef) {
  var v = "''";
...
var mongoEmptyValue = exports.mongoEmptyValue = function mongoEmptyValue(fieldDef) {
  var v = "";
  var type = fieldDef === null || fieldDef === void 0 ? void 0 : fieldDef.type;
  if (type == "number") {
    v = 0;
...
var spelFixList = exports.spelFixList = function spelFixList(val) {
  // `{1,2}.contains(1)` NOT works
  // `{1,2}.?[true].contains(1)` works
  return "".concat(val, ".?[true]");
};
var spelEscape = exports.spelEscape = function spelEscape(val) {
...
var spelFormatConcat = exports.spelFormatConcat = function spelFormatConcat(parts) {
...
var spelImportConcat = exports.spelImportConcat = function spelImportConcat(val) {
