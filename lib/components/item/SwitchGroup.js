...
new (function (_class2) {
  var SwitchGroup = /*#__PURE__*/function (_BasicGroup) {
    ...
    function SwitchGroup(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "hasDefaultCase", function () {
  ...
  function _class3() {
    ...
    (_this2 = _super2.call(this, _SwitchGroup), _defineProperty(_assertThisInitialized(_this2), "propTypes", _objectSpread({}, _Group.BasicGroup.propTypes))), _initClass();
    return _this2;
  }
