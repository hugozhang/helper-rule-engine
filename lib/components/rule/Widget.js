...
var Widget = /*#__PURE__*/function (_PureComponent) {
  ...
  function Widget(_props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_setValue", function (isSpecialRange, delta, widgetType, value, asyncListValues, __isInternal) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_onChangeValueSrc", function (delta, srcKey) {
      _this.props.setValueSrc(delta, srcKey);
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderWidget", function (delta, meta, props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderValueSources", function (delta, meta, props) {
      var config = props.config,
        isFuncArg = props.isFuncArg,
        leftField = props.leftField,
        operator = props.operator,
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderSep", function (delta, meta, props) {
      var config = props.config;
      var widgets = meta.widgets;
      var settings = config.settings;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderWidgetDelta", function (delta) {
...
(0, _defineProperty2["default"])(Widget, "propTypes", {
