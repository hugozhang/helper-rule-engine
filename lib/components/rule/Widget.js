...
var Widget = /*#__PURE__*/function (_PureComponent) {
  ...
  function Widget(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_setValue", function (isSpecialRange, delta, widgetType, value, asyncListValues, __isInternal) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_onChangeValueSrc", function (delta, srcKey) {
      _this.props.setValueSrc(delta, srcKey);
    });
    _defineProperty(_assertThisInitialized(_this), "renderWidget", function (delta, meta, props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderValueSources", function (delta, meta, props) {
      var config = props.config,
        isFuncArg = props.isFuncArg,
        leftField = props.leftField,
        operator = props.operator,
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSep", function (delta, meta, props) {
      var config = props.config;
      var widgets = meta.widgets;
      var settings = config.settings;
    ...
    _defineProperty(_assertThisInitialized(_this), "renderWidgetDelta", function (delta) {
