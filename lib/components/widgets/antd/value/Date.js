...
var DateWidget = /*#__PURE__*/function (_PureComponent) {
  ...
  function DateWidget(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "isValidSingleValue", function (value) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getMomentSingleValue", function (value) {
      var valueFormat = _this.props.valueFormat;
      var v = value ? (0, _moment["default"])(value, valueFormat) : null;
      if (v && !v.isValid()) v = null;
      return v;
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getMomentValue", function (value) {
      var isSpecialRange = _this.props.isSpecialRange;
      if (isSpecialRange) return value ? value.map(function (el) {
        return _this.getMomentSingleValue(el);
      }) : [null, null];else return _this.getMomentSingleValue(value);
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "formatSingleValue", function (value) {
      var valueFormat = _this.props.valueFormat;
...
(0, _defineProperty2["default"])(DateWidget, "propTypes", {
...
(0, _defineProperty2["default"])(DateWidget, "defaultProps", {
