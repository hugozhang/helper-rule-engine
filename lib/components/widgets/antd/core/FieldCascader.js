...
var FieldCascader = /*#__PURE__*/function (_PureComponent) {
  ...
  function FieldCascader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (keys) {
    ...
    _defineProperty(_assertThisInitialized(_this), "filterOption", function (inputValue, path) {
...
_defineProperty(FieldCascader, "propTypes", {
