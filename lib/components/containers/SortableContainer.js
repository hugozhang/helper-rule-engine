...
var createSortableContainer = function createSortableContainer(Builder) {
  ...
  return _class = /*#__PURE__*/function (_Component) {
    ...
    function SortableContainer(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "_getEventTarget", function (e, dragStart) {
        return e && e.__mocked_window || document.body || window;
      });
      _defineProperty(_assertThisInitialized(_this), "onDragStart", function (id, dom, e) {
