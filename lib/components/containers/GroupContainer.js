...
var createGroupContainer = function createGroupContainer(Group) {
  ...
  return _class = /*#__PURE__*/function (_Component) {
    ...
    function GroupContainer(_props) {
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_selectedConjunction", function (props) {
        props = props || _this.props;
        return props.conjunction || (0, _defaultUtils.defaultGroupConjunction)(props.config, props.field);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setConjunction", function () {
      ...
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setNot", function () {
        var not = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        _this.props.actions.setNot(_this.props.path, not);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setLock", function () {
        var lock = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        _this.props.actions.setLock(_this.props.path, lock);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "dummyFn", function () {});
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "removeSelf", function () {
        _this.props.actions.removeGroup(_this.props.path);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "addGroup", function () {
        _this.props.actions.addGroup(_this.props.path);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "addCaseGroup", function () {
        _this.props.actions.addCaseGroup(_this.props.path);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "addDefaultCaseGroup", function () {
        _this.props.actions.addDefaultCaseGroup(_this.props.path);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "addRule", function () {
        _this.props.actions.addRule(_this.props.path);
      });
      // for RuleGroup
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setField", function (field) {
        _this.props.actions.setField(_this.props.path, field);
      });
      // for RuleGroupExt
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setOperator", function (operator) {
        _this.props.actions.setOperator(_this.props.path, operator);
      });
      (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setValue", function (delta, value, type) {
