...
var widgets = {
  ...
  date: {
    ...
    spelFormatValue: function spelFormatValue(val, fieldDef, wgtDef, op, opDef) {
      ...
      return "string_to_date('".concat(dateVal.format("YYYY-MM-DD"), "', 'yyyy-MM-dd')");
    },
  ...
  time: {
    ...
    spelFormatValue: function spelFormatValue(val, fieldDef, wgtDef, op, opDef) {
      ...
      return "string_to_date('".concat(dateVal.format("HH:mm:ss"), "', 'HH:mm:ss')");
    },
    jsonLogic: function jsonLogic(val, fieldDef, wgtDef) {
  ...
  datetime: {
    ...
    spelFormatValue: function spelFormatValue(val, fieldDef, wgtDef, op, opDef) {
      ...
      return "string_to_date('".concat(dateVal.format("YYYY-MM-DD HH:mm:ss"), "', 'yyyy-MM-dd HH:mm:ss')");
    },
    jsonLogic: function jsonLogic(val, fieldDef, wgtDef) {
      return (0, _moment["default"])(val, wgtDef.valueFormat).toDate();
    },
