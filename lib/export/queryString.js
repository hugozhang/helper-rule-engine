...
var queryString = exports.queryString = function queryString(item, config) {
  var isForDisplay = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  //meta is mutable
  var meta = {
    errors: []
  };
...
var formatGroup = function formatGroup(item, config, meta) {
  ...
  var conjStr = list.size ? conjunctionDefinition.formatConj(list, conjunction, not, isForDisplay, mode) : null;
  var ret;
  if (groupField) {
